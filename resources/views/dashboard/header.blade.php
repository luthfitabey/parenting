...
<!--
      ...
      @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="btn btn-success text-sm text-white-700 dark:text-white-500 underline">Home</a>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary" href="#book-a-table">Log in</a>
